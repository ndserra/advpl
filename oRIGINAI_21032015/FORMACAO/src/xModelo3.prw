...
Private oTotal                    
	...
	fDadosJanela() // tratando a dimensão da tela
...
DEFINE MSDIALOG oDlg TITLE cCadastro FROM aSize[7],aSize[1] TO aSize[6],aSize[5] OF oMainWnd PIXEL
 ...
 //EnchoiceBar(Confirmar,Cancelar) //Botões		
 // Obrigatorio valida todos os campos do EnChoice
