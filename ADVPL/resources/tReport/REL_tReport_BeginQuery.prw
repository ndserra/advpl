...
oSection := TRSection():New(oReport,"Dados dos Clientes",{"SA1"} ) /* Definição da criação de uma seção */

	TRCell():New(oSection,"A1_EST"    , "SA1")
	TRCell():New(oSection,"A1_COD"    ," SA1","Cliente") /* Aqui é definido um cabeçalho diferente para A1_COD*/
