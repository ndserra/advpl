...
/* ===============================================================================
WSDL Location    http://localhost:5580/ws/XMOSTRASALDO.apw?WSDL
Gerado em        04/11/15 15:48:18
Observações      Código-Fonte gerado por ADVPL WSDL Client 1.120703
                 Alterações neste arquivo podem causar funcionamento incorreto
                 e serão perdidas caso o código-fonte seja gerado novamente.
=============================================================================== */

User Function _ONKFKNL ; Return  // "dummy" function - Internal Use 
...
cSoap += '<MOSTRASALDO xmlns="http://localhost:5580/">'
cSoap += WSSoapValue("PRODUTO", ::cPRODUTO, cPRODUTO , "string", .T. , .F., 0 , NIL, .F.) 
cSoap += "</MOSTRASALDO>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://localhost:5580/MOSTRASALDO",; 
	"DOCUMENT","http://localhost:5580/",,"1.031217",; 
	"http://localhost:5580/ws/XMOSTRASALDO.apw")
