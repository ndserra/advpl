...
Gerado em        04/11/15 14:29:46
Observações      Código-Fonte gerado por ADVPL WSDL Client 1.120703
                 Alterações neste arquivo podem causar funcionamento incorreto
                 e serão perdidas caso o código-fonte seja gerado novamente.
=============================================================================== */

User Function _MHVDNGW ; Return  // "dummy" function - Internal Use 
...
cSoap += '<MOSTRAHORA xmlns="http://localhost:5580/">'
cSoap += WSSoapValue("PARAMETRO", ::cPARAMETRO, cPARAMETRO , "string", .T. , .F., 0 , NIL, .F.) 
cSoap += "</MOSTRAHORA>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"http://localhost:5580/MOSTRAHORA",; 
	"DOCUMENT","http://localhost:5580/",,"1.031217",; 
	"http://localhost:5580/ws/LISTA_DATA.apw")
