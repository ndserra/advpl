...
@ 005,005 LISTBOX oLbx1 FIELDS HEADER "Cliente","Loja","Nome ","Estado","Ultima Compra","Bloqueado" SIZE 456,205 PIXEL OF oFld:aDialogs[1]
...
Local cAliasEXC  := GetNextAlias() //Criando um alias de memoria                                     
Local cSql      := ""
...
cSql += "      ,[R_E_C_N_O_]                        "
cSql += "      ,[R_E_C_D_E_L_]                      "
cSql += "  FROM dbhomologacao.[dbo].[TOTVS_ADTDET]  "

dbUseArea( .T.,"TOPCONN", TCGENQRY(,,cSql),(cAliasEXC), .F., .T.)
